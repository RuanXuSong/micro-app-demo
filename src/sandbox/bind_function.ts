...
function isBoundedFunction(
  value: CallableFunction & { __MICRO_APP_IS_BOUND_FUNCTION__: boolean }
): boolean {
...
function isConstructor(
  value: FunctionConstructor & { __MICRO_APP_IS_CONSTRUCTOR__: boolean }
) {
...
export default function bindFunctionToRawWindow(
  rawWindow: Window,
  value: any
): unknown {
